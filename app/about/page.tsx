    ...
    try {
        ...
        return (
            <div className="min-h-screen bg-white">
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="relative h-48 md:h-64 rounded-xl overflow-hidden shadow-lg">
                                    <Image
                                        src="/printing-press-with-colorful-cmyk-ink-rollers.jpg"
                ...
                {/* About Section */}
                <section id="about" className="py-20 bg-[var(--background-alt)]">
                    <div className="container mx-auto px-6 md:px-12 lg:px-20">
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            ...
                            viewport={{ once: true }}
                        >
                            <h2 className="section-title text-center mb-4">About Myanmar Print & Pack</h2>
                            <p className="section-subtitle text-center mb-16">
                                A diversified printing and packaging solutions company committed to excellence and innovation
                            </p>
                            ...
                            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                                ...
                                <div>
                                    ...
                                    <p className="text-[var(--text-secondary)] mb-6">
                                        Myanmar Print & Pack was established in 2016 with a vision to provide comprehensive printing and packaging
                                        solutions to businesses across Myanmar. Through our strategic subsidiaries, we deliver exceptional products and
                                        services that meet the diverse needs of our clients.
                                    </p>
                                    <h3 className="text-2xl font-bold mb-4">Our Commitment</h3>
                                    <p className="text-[var(--text-secondary)]">
                                        We are dedicated to maintaining the highest standards of quality, innovation, and customer service. Our
                                        integrated approach allows us to serve multiple sectors including printing supplies, packaging solutions, and
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                                {stats.map((stat, index) => (
                                    <div key={index} className="text-center">
                                        <div className="text-4xl font-bold text-[var(--primary-color)] mb-2">{stat.number}</div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                            ...
                            >
                                ...
                                <div className="space-y-4">
                                    {["MAB", "AYA Bank", "KBZ Bank"].map((bank) => (
                                        <div
                                            key={bank}
